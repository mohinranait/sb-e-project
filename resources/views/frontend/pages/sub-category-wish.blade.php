			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="masonry-loader masonry-loader-showing">
						...
						<!--$categorys asca pageController thaka, products function asca Category Model thaka  -->
						@php $pro = $categorys->products()->get(); @endphp
							@if(   $pro->count() > 0)
							...
							<div class="alert alert-info">
								No Product Found <strong> {{$categorys->title}}</strong>
							</div>
							@endif
