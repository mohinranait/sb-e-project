									...
									<div class="card-body">
										...
										<div class="form-row">
											<div class="form-group col-lg-6">
												...
												<select name="division" class='form-control' required id="">
											...
											<div class="form-group col-lg-6">
												...
												<select name="district" class='form-control' required id="">
										...
										<div class="form-row">
											<div class="form-group col">
												<label class="font-weight-bold text-dark  text-2" required>Cuntry </label>
					...
					<table class="cart-totals">
						<tbody>
							<tr class="cart-subtotal">
								...
								<td>
									<strong class="text-dark"><span class="amount">৳ {{App\Models\Card::totalPrice()}}</span></strong>
								</td>
							</tr>
							<tr class="shipping">
								<th>
