...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(Auth::check()){
            ...
            $post_data = array();
            $post_data['total_amount']      = $request->ammount; # You cant not pay less than 10
            ...
            $post_data['cus_last_name']     = $request->last_name;
            ...
            $post_data['cus_fax']           = "";
            $post_data['cus_massage']       = $request->message;
